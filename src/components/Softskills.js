            ...
            <div className="skill-bx wow zoomIn">
              ...
              <Carousel responsive={responsive} infinite={true} className="owl-carousel owl-theme skill-slider">
                ...
                <img src={teamwork} alt="teamwork" />
                  <h5>{t.softskills.items.teamwork}</h5>
                </div>
                <div className="item">
                <img src={friendliness} alt="friendliness" />
                  <h5>{t.softskills.items.friendliness}</h5>
                </div>
                <div className="item">
                <img src={responsibility} alt="responsibility" />
                  <h5>{t.softskills.items.responsibility}</h5>
                </div>
                <div className="item">
                 <img src={smanagement} alt="self-management" />
                  <h5>{t.softskills.items.selfManagement}</h5>
                </div>
                <div className="item">
                <img src={goodcomunication} alt="good-comunication" />
                  <h5>{t.softskills.items.communication}</h5>
                </div>
